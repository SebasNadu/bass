...
docker-compose -f /home/ubuntu/app/docker-compose.prod.yml build
docker-compose -f /home/ubuntu/app/docker-compose.prod.yml up -d

#aws elbv2 register-targets --region ap-northeast-2 --target-group-arn arn:aws:elasticloadbalancing:ap-northeast-2:843255971531:targetgroup/tg-bass-green/491545447800a047 --targets Id=i-05eae5cc25670bd7e,Port=8082
#
#APP_NAME="bass"
